function txt_bar() {
	...
	txt("Dingy, drab, and inelegant. It does not appear to be fit for a princess.", KOTOHIME.NORMAL, SPRITEPOS.MIDRIGHT),
	...
	txt("..."),
	txt("And here we are!", KOTOHIME.NORMAL, SPRITEPOS.MIDLEFT),
	...
	txt("It is true that this place is nice... but for a place to convene during the day, it is unusual.", KAGUYA2.NORMAL),
	...
	txt("For humans who work in the day and youkai who prowl in the night, it's unfair to give credence to one or the other in this place.", KOTOHIME.NORMAL, SPRITEPOS.MIDRIGHT),
	...
	txt("No, I just made that up. It sort of fits, though.", KOTOHIME.NORMAL, SPRITEPOS.MIDLEFT),
	...
	txt("HEY, RIKA! GET US SOMETHING LIGHT!", KOTOHIME.NORMAL, SPRITEPOS.CENTER),
	...
	txt("In fact-#Well, Chiyurii, can you keep a secret?", KOTOHIME.NORMAL, SPRITEPOS.CENTER),
