function txt_immortal() {
	...
	txt("I am exiled from all pure lands, the moon nor the Netherworld will accept me.", KAGUYA2.HAPPY),
	txt("It is impossible to me to lead a life parallel to a mortal's.", KAGUYA2.HAPPY),
	...
	txt("Do you believe it to be a curse?", KAGUYA2.HAPPY),
	...
	txt("...Kotohime, you...", KAGUYA2.CONFUSED),
	ntxt(0, u, u, u, function() {instance_create(640, 360, o_bjection, "Instances_ui")}),
