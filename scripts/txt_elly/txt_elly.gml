function txt_elly() {
	...
	txt("None of these women seem terribly approachable...", KAGUYA2.NORMAL, SPRITEPOS.MIDRIGHT, s_thebar, function() {music_set(mus.null)}),
	txt("Admittedly, the bachelorettes of the Twilight Bar are a fair bit eccentric.", KOTOHIME.THINKING, SPRITEPOS.RIGHT),
	txt("|c102137255Who could have guessed?", KAGUYA2.NORMAL),
	txt("Slow day, is it?", KAGUYA2.NORMAL),
	txt("Yield not, Ka- Tsukiko!", KOTOHIME.WINK),
	txt("Please do remember my new name.", KAGUYA2.NORMAL),
	txt("For there is yet still a lonely lady just around the corner!", KOTOHIME.HAPPY),
	txt("This feels somewhat ironic. Have I already reached desperation?", KAGUYA2.NORMAL),
	txt("Hark; just behind that pillar lies our perfect target!", KOTOHIME.HAPPY),
	txt("Calling them a \"target\"... this really is a crass mission.", KAGUYA2.NORMAL),
	...
	txt("...Very well. I will continue to entertain this goal.", KAGUYA2.NORMAL),
	...
	txt("Good evening.", KAGUYA2.NORMAL),
	...
	txt("Not terribly much. I had been enjoying this bar, and became curious to make the acquaintence of one of its' regulars.", KAGUYA2.NORMAL),
	txt("May I?", KAGUYA2.NORMAL),
	txt("Um, sure.", ELLY.SURPRISED),
	txt("|c160160160Kaguya gracefully takes a seat across from the hooded woman."),
	txt("My name is Tsukiko. It's nice to meet you.", KAGUYA2.NORMAL),
	txt("Elly. Same here.", ELLY.FAKELAUGH),
	txt("Elly, may I ask about that weapon of yours?", KAGUYA2.NORMAL),
	txt("It's very elegant.", KAGUYA2.NORMAL),
	txt("Thanks... it's a scythe.", ELLY.FAKELAUGH),
	txt("Do you work as a shinigami, perchance?", KAGUYA2.NORMAL),
	txt("I rarely see such sort in the commonplace of Gensokyo.", KAGUYA2.NORMAL),
	txt("Well, not really. I'm more of a \"reaper\" than a shinigami.", ELLY.BORED),
	txt("Oh? What's a reaper?", KAGUYA2.NORMAL),
	...
	txt("That sounds nice. No bureaucracy.", KAGUYA2.NORMAL),
	...
	txt("I was... but I've always lived in Gensokyo.", KAGUYA2.NORMAL),
	...
	txt("I can sympathize. I'm capable when it comes to magical combat, but I don't have the constitution or technique for brawls.", KAGUYA2.NORMAL),
	txt("...Do you get into brawls much, in Gensokyo?", ELLY.CONFUSED),
	txt("Well... surprisingly, yes. I've got an enemy who leaves me little other choice.", KAGUYA2.NORMAL),
	...
	txt("Ah, I remember those...", KAGUYA2.NORMAL),
	txt("Did something have you hesitate?", KAGUYA2.NORMAL),
	...
	txt("I have no qualms with sharing.", KAGUYA2.NORMAL),
	txt("|c102137255Although I'll have to edit around \"Kaguya\"...", KAGUYA2.NORMAL),
	txt("My manor is in a quite remote location.", KAGUYA2.NORMAL),
	txt("Manor? You're nobility?", ELLY.SURPRISED),
	txt("Oh, no. It's just something me and my friends happened upon. A lucky place to have taken residence at.", KAGUYA2.NORMAL),
	txt("However, it's very hard to locate.", KAGUYA2.NORMAL),
	txt("I was impressed when a lone human woman found it.", KAGUYA2.NORMAL),
	txt("That's me!", KOTOHIME.LMAO),
	txt("She threw herself in with us, seemingly just looking for a good time.", KAGUYA2.NORMAL),
	txt("Uh-huh.", ELLY.FAKELAUGH),
	txt("My friends are rather work-oriented, and were quick to drive her out.", KAGUYA2.NORMAL),
	txt("Magicians, or something?", ELLY.SURPRISED),
	txt("Of the sort.", KAGUYA2.NORMAL),
	txt("But I turned around and offered my services as a noblewoman of endless talents!", KOTOHIME.HAPPY),
	txt("...So, she came to our employment in retreiving some rare items we had sent out for.", KAGUYA2.NORMAL),
	...
	txt("Oh. I hadn't thought that far ahead.", KAGUYA2.NORMAL),
	txt("|c102137255I truly hadn't.", KAGUYA2.NORMAL),
	txt("|c102137255Can I keep this up?", KAGUYA2.NORMAL),
	txt("Hey, why not?", KOTOHIME.HAPPY),
	txt("Next time you can meet Rika, too.", KOTOHIME.EXCITED),
	txt("Yes, I...", KAGUYA2.NORMAL),
	txt("|c102137255Ah... to do this again?", KAGUYA2.NORMAL),
