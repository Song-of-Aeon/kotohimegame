function txt_gaming() {
	...
	txt("As unassuming as always, isn't it? Incredible, that this thing could contain such enveloping mysteries.", KOTOHIME.NORMAL),
	...
	txt("Okay, it looks like there are three folders here..."),
	txt("They must all be decent. This time, I had that outsider girl contracted."),
	txt("I guess the girl I picked it up from did look kind of weird..."),
	txt("There's an outsider girl who can go back and forth?"),
	txt("You... haha! I didn't think there was someone more secluded from current events than I!"),
	txt("Yes, well, I have a very busy schedule. Many princessly duties. I'm sure you understand."),
	txt("Hehe, of course."),
	txt("A miracle that we both are given this chance to meet today."),
	txt("Nothing but."),
	txt("Anyway, which one should we try first?"),
	txt(""),
