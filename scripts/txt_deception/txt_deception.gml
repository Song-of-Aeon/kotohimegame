function txt_deception() {
	...
	txt("That thing I brought~", KOTOHIME.NORMAL),
	txt("I sorta lost it~", KOTOHIME.NORMAL),
	txt("How did you...", REISEN.HAPPY),
	txt("Wait, you showed it to Eirin and I before you met the princess.", REISEN.HAPPY),
	txt("That was, uh, the last one. I still had it with me.", KOTOHIME.NORMAL),
	txt("And you were together for so long. How did she just notice now?", REISEN.HAPPY),
	txt("The people of Hourai live incredibly long lives. Our presence in her eyes is only a blip amidst an eternal storm.", KOTOHIME.NORMAL, SPRITEPOS.CENTER),
	txt("Any individual meeting of ours, a blip of a blip.", KOTOHIME.NORMAL),
	txt("Sure.", REISEN.HAPPY),
	txt("I had thought that maybe one such as her would not notice if a sub-blip repeated itself.", KOTOHIME.NORMAL, SPRITEPOS.MIDLEFT),
	txt("And I was right! For a while! Eventually she realized-", KOTOHIME.NORMAL),
	...
	txt("Yes, well, gaslight, gatekeep, g-", KOTOHIME.NORMAL, SPRITEPOS.RIGHT),
	...
	txt("Wait!!", KOTOHIME.NORMAL, SPRITEPOS.MIDRIGHT),
	txt("I was wondering if you might aid me on my path to repentence.", KOTOHIME.NORMAL),
	txt("I know what I did was awful...", KOTOHIME.NORMAL),
	txt("But there's one more thing I can do to atone!", KOTOHIME.NORMAL),
	txt("It's for \"the princess\", right? I'm sure she wouldn't mind if you helped.", KOTOHIME.NORMAL),
