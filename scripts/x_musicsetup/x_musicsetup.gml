...
nu song("immortal smoke night", "isnight", [m_immortal_smoke_night]);
nu song("and dies", "dies", [m_dies]);
nu song("gaming time", "gaming", [m_gaming]);
nu song("reisen chess fight", "chesshogi", [m_chesshogi]);
nu song("gaming 2", "vidya2", [m_vidyagaem_2]);
nu song("kaguya and mokou fight", "faito", [m_faito]);
