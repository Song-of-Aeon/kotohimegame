function txt_afterword() {
	...
	txt("Most of the writing was done in two weeks-- the first half of the month was spent reading official print works for research, and writing a big section that got thrown out because we didn't have time to make art for it."),	
	txt("And pretty much all of the gameplay segment was made in the last few days, featuring me trying to code patterns with Aeon's danmaku system even though I have virtually no knowledge of programming."),
