function txt_kana() {
	...
	txt("Kotohime, that person over there...", KAGUYA2.NORMAL, u, s_thebar),
...
function txt_ruukoto() {
	...
	txt("Is that girl alright? She's drinking so much, alone, at this time of day...", KAGUYA2.NORMAL, u, s_thebar),
