function txt_chillin() {
	...
	txt("Kotohime, I'm surprised you can take this so seriously.", KAGUYA2.HAPPY, SPRITEPOS.CENTER, s_gaming, function() {music_set(mus.chillin)}),
	txt("Do you not have your \"princessly duties\" this eve?", KAGUYA2.GRIN),
	txt("Alas, the eve has already given way to morrow.", KOTOHIME.THINKING, SPRITEPOS.LEFT),
	txt("So it has...", KAGUYA2.DISAPPOINTED),
	txt("Especially with that, will you be staying much longer?", KAGUYA2.HAPPY, SPRITEPOS.MIDRIGHT),
	...
	txt("Troublesome, surely...", KAGUYA2.DISAPPOINTED),
	txt("Besides that, marriage proposals?", KAGUYA2.GRIN),
	...
	txt("Ah...", KAGUYA2.CONFUSED),
	txt("Do you bother reading past the sender's name, sometimes?", KAGUYA2.CONFUSED),
	txt("Not even once.", KOTOHIME.HAPPY),
	txt("I would recommend trying, if only for the humor of it.", KAGUYA2.SMUG),
	txt("And there may be some... feelings... that might be worth understanding, even if you cannot reciprocate.", KAGUYA2.GRIN),
	...
	txt("Oh, not at all. The forest does wonders for keeping out the riff-raff, disregarding that assassin of mine.", KAGUYA2.HAPPY),
	txt("I don't suppose I've heard anything of the sort since-", KAGUYA2.HAPPY),
	txt("No, there was one bold girl during my stay on the moon after leaving Earth.", KAGUYA2.DISAPPOINTED),
	txt("But she wasn't to a princess' standards.", KOTOHIME.THINKING),
	txt("I wouldn't know. Once word got out, she was punished severely. I never saw her face.", KAGUYA2.CONFUSED),
	txt("Ouch.", KOTOHIME.NERVOUS),
	txt("The Lunar Capital is rigid in its ways.", KAGUYA2.GRIN),
	txt("...", KOTOHIME.THINKING),
	txt("...Have I given you something to consider, Kotohime?", KAGUYA2.CONFUSED),
	...
	txt("Kotohime, are you insane?", KAGUYA2.SURPRISED),
	txt("It's the only way anything gets done.", KOTOHIME.SMUG),
	txt("In the first place, I'm not someone who can just show myself freely. Everybody's heard of my past.", KAGUYA2.ANGRY),
	txt("Hm.", KOTOHIME.THINKING),
	txt("Eirin wouldn't entertain the thought.", KAGUYA2.DISAPPOINTED),
	txt("Hmm~? Is she your superior~?", KOTOHIME.SMUG),
	txt("No... but that is the top of the list. It is infeasible.", KAGUYA2.CONFUSED),
	...
	txt("Stop it, you.", KAGUYA2.ANGRY),
	txt("It is true that your proposition is interesting.", KAGUYA2.CONFUSED),
	txt("I simply cannot imagine how it could be approached.", KAGUYA2.CONFUSED),
	...
	txt("...They couldn't be that ignorant.", KAGUYA2.ANGRY),
	...
	txt("But, in Gensokyo?", KAGUYA2.CONFUSED),
	txt("In Gensokyo.", KOTOHIME.SMUG),
	txt("If there really is a place I can enter without any biases amongst its denizens...", KAGUYA2.CONFUSED),
	txt("Then, we just need to sneak out.", KOTOHIME.HAPPY),
	txt("Always thrilling. How will we do it?", KAGUYA2.GRIN),
