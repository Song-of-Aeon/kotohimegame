function txt_freedom() {
	...
	txt("...Hey! Kotohime!"),
	txt("|c102137255KAGUYA2's out! I need to get rid of Reisen.", KOTOHIME.NORMAL),
	...
	txt("Hehe, that was fun.", KAGUYA2.NORMAL),
	...
	txt("It is the folly of the noble to look down upon the common man, KAGUYA2.", KOTOHIME.NORMAL),
	...
	txt("I don't mind walking, then. It will make it harder to be caught, as well.", KAGUYA2.NORMAL),
