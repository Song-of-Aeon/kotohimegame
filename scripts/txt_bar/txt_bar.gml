function txt_bar() {
	...
	txt("In truth, it is actually quite nice inside.", KOTOHIME.HAPPY),
	...
	txt("It's impossible for one to tell the time here; there's not even any windows open.", KAGUYA2.NORMAL),
	txt("That's sort of a policy here.", KOTOHIME.HAPPY),
	txt("This place is open to human and youkai alike, as well?", KAGUYA2.NORMAL),
	txt("Of course. That's part of why the time of day is ignored.", KOTOHIME.HAPPY),
	txt("For humans who work in the day and youkai who prowl in the night, it's unfair to give credence to one or the other in this place.", KOTOHIME.HAPPY, SPRITEPOS.MIDRIGHT),
	txt("I told you, didn't I? This place is unconcerned with the outside's business.", KOTOHIME.HAPPY),
	txt("This bar exists in perpetual twilight, never bound to the sun or the moon, to human or youkai. We are equals in the dusk glow.", KOTOHIME.HAPPY),
	txt("Hence the name.", KAGUYA2.NORMAL),
	txt("No, I just made that up. It sort of fits, though.", KOTOHIME.HAPPY, SPRITEPOS.MIDLEFT),
	txt("Should a princess truly be able to lie as easily as she breathes?", KAGUYA2.NORMAL),
	txt("That's the mark of the poet, dear Kaguya.", KOTOHIME.HAPPY),
	txt("I hope poetry is all you put such words to use for.", KAGUYA2.NORMAL),
	txt("Yes...#Regardless, shall we venture forth?", KOTOHIME.HAPPY),
	...
	txt("HEY, RIKA! GET US SOMETHING LIGHT!", KOTOHIME.HAPPY, SPRITEPOS.CENTER),
	txt("AT LEAST COME OVER TO THE DAMN BAR, KOTOHIME!", CHIYURI.NOTHING),
	txt("A reasonable request. I'll be back in a moment.", KOTOHIME.HAPPY),
	...
	txt("So I gather. Hi, Chiyurii!", KOTOHIME.HAPPY, SPRITEPOS.MIDLEFT),
	...
	txt("Oh, but she is quite a refined lady.", KOTOHIME.HAPPY),
	...
	txt("|s0.5(She's Kaguya! From, you know!)", KOTOHIME.HAPPY),
	txt("|s0.5(!!)#(You mean, that Kaguya?)", CHIYURI.NOTHING),
	txt("|s0.5(Yes!)", KOTOHIME.HAPPY),
