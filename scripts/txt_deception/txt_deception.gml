function txt_deception() {
	...
	txt("I sorta lost it~", KOTOHIME.HAPPY),
	txt("How did you...", REISEN.HAPPY),
	txt("Wait, you showed it to Eirin and I before you met the princess.", REISEN.HAPPY),
	txt("That was, uh, the last one. I still had it with me.", KOTOHIME.HAPPY),
	txt("And you were together for so long. How did she just notice now?", REISEN.HAPPY),
	txt("The people of Hourai live incredibly long lives. Our presence in her eyes is only a blip amidst an eternal storm.", KOTOHIME.HAPPY, SPRITEPOS.CENTER),
	txt("Any individual meeting of ours, a blip of a blip.", KOTOHIME.HAPPY),
	txt("Sure.", REISEN.HAPPY),
	txt("I had thought that maybe one such as her would not notice if a sub-blip repeated itself.", KOTOHIME.HAPPY, SPRITEPOS.MIDLEFT),
	txt("And I was right! For a while! Eventually she realized-", KOTOHIME.HAPPY),
	...
	txt("Yes, well, gaslight, gatekeep, g-", KOTOHIME.HAPPY, SPRITEPOS.RIGHT),
	...
	txt("Wait!!", KOTOHIME.HAPPY, SPRITEPOS.MIDRIGHT),
	txt("I was wondering if you might aid me on my path to repentence.", KOTOHIME.HAPPY),
	txt("I know what I did was awful...", KOTOHIME.HAPPY),
	txt("But there's one more thing I can do to atone!", KOTOHIME.HAPPY),
	txt("It's for \"the princess\", right? I'm sure she wouldn't mind if you helped.", KOTOHIME.HAPPY),
	...
	txt("If we find it quickly, maybe Kaguya will calm down. Besides, most people can't navigate the Bamboo Forest as well as someone who lives in it, right?", KOTOHIME.HAPPY),
