function txt_return() {
	...
	ntxt(0, KAGUYA2.HAPPY, SPRITEPOS.MIDLEFT),
	...
	txt("Yes...#Before that, Elly, I must apologize.", KAGUYA2.DISAPPOINTED),
	txt("Sure?", ELLY.CONFUSED),
	txt("When Kotohime and I first came to this place together, it was because she had evaluated that it would be one where I was not immediately recognized.", KAGUYA2.HAPPY),
	txt("I am fairly well-known throughout Gensokyo these days.", KAGUYA2.HAPPY),
	txt("For the sake of socialization without such preconceptions, I adopted the false identity of \"Tsukiko\".", KAGUYA2.DISAPPOINTED),
	txt("Oh. Okay. Who are you, then?", ELLY.SURPRISED),
	txt("I am Kaguya Houraisan, of Eientei.", KAGUYA2.HAPPY),
	...
	txt("Yes. I created and consumed the Hourai Elixir over a thousand years ago.", KAGUYA2.SMUG),
	...
	txt("Certainly.", KAGUYA2.EXCITED),
	txt("An honor, then.", ELLY.FAKELAUGH),
	txt("Please don't treat it as special. I wanted to come here as a commoner, and...", KAGUYA2.HAPPY),
	txt("I believe I'll be coming back again as one, as well.", KAGUYA2.GRIN),
	txt("Yay!", KOTOHIME.EXCITED),
	txt("I'll be looking forward to it.", ELLY.BLUSH),
	txt("For the moment, however, I ought to be returning home.", KAGUYA2.HAPPY),
	txt("I do not want my house searching too hard and finding this place.", KAGUYA2.HAPPY),
	txt("Fair enough. When will you be back?", ELLY.SURPRISED),
	txt("I couldn't quite say. Typically, I may let a hundred years pass before remembering...", KAGUYA2.SMUG),
	txt("But now, I have a human or two to worry about. It may be within the moon.", KAGUYA2.GRIN),
	txt("Okay! I'll probably be around here.", ELLY.HAPPY),
	txt("Good eve, Elly.", KAGUYA2.HAPPY),
	txt("Bye!", ELLY.BLUSH),
