function txt_bar() {
	...
	txt("It is true that this place is nice... but for somewhere to convene during the day, it is unusual.", KAGUYA2.CONFUSED),
	txt("It's impossible for one to tell the time here; there's not even any windows.", KAGUYA2.CONFUSED),
	txt("That's sort of a policy here.", KOTOHIME.THINKING),
	txt("This place is open to human and youkai alike, as well?", KAGUYA2.CONFUSED),
	...
	txt("Hence the name.", KAGUYA2.GRIN),
	txt("No, I just made that up. It sort of fits, though.", KOTOHIME.LMAO, SPRITEPOS.MIDLEFT),
	txt("Should a princess truly be able to lie as easily as she breathes?", KAGUYA2.CONFUSED),
	txt("That's the mark of the poet, dear Kaguya.", KOTOHIME.WINK),
	txt("I hope poetry is all you put such words to use for.", KAGUYA2.GRIN),
	txt("Yes...#Regardless, shall we venture forth?", KOTOHIME.THINKING),
	txt("I'd like to take some time to get acquainted with the atmosphere, before doing anything.", KAGUYA2.HAPPY),
	...
	txt("Yo. Who's the new girl?", CHIYURI.HAPPY),
	txt("Just a friend. Well, a fellow princess-in-arms.", KOTOHIME.HAPPY),
	txt("A princess...? I guess they aren't all that uncommon. She does look the part.", CHIYURI.STERN),
	...
	txt("Sure.", CHIYURI.STERN, SPRITEPOS.MIDRIGHT),
	txt("|s0.5(She's Kaguya! From, you know!)", KOTOHIME.LMAO),
	txt("|s0.5(!!)#(You mean, that Kaguya?)", CHIYURI.INTERESTED),
	txt("|s0.5(Yes!)", KOTOHIME.EXCITED),
	txt("...Oh boy.#We're gonna have a problem.", CHIYURI.STERN, SPRITEPOS.RIGHT),
	txt("Kotohime, follow me.", CHIYURI.ANNOYED),
	ntxt(0, KOTOHIME.EXCITED, SPRITEPOS.LEFT),
	ntxt(0, CHIYURI.ANNOYED, SPRITEPOS.CENTER),
	...
	txt("Yeah, something's wrong.", CHIYURI.ANNOYED, SPRITEPOS.MIDRIGHT),
