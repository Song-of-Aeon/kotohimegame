function txt_gaming() {
	...
	txt("As unassuming as always, isn't it? What mysteries does it bring to us this time...?", KOTOHIME.THINKING),
	txt("Yes, certainly.", KAGUYA2.NORMAL),
	txt("It was quite the wait. Let us see what it has to offer.", KAGUYA2.NORMAL),
