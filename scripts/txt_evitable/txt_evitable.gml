function txt_evitable() {
	...
	txt("|aReally?", KAGUYA2.CONFUSED, SPRITEPOS.MIDLEFT, u, u, [se_23]),
	txt("But of course.", KOTOHIME.SMUG, SPRITEPOS.MIDRIGHT, s_court),
	txt("How could it be done, then?", KAGUYA2.CONFUSED),
	txt("To maintain a deeper and deeper interpersonal relationship without ever breathing one's true identity?", KAGUYA2.GRIN),
	...
	txt("...I can't.", KAGUYA2.ANGRY),
	txt("|aOh. Right.", KOTOHIME.NERVOUS, SPRITEPOS.MIDRIGHT, s_court, u, [se_25]),
	txt("Kotohime, take this seriously.", KAGUYA2.ANGRY),
	txt("Can you really argue that the existence of \"Tsukiko\" is sustainable?", KAGUYA2.GRIN),
