function txt_immortal() {
	...
	txt("...I am such a fool who does not.", KOTOHIME.HAPPY),
	txt("However, humans also do not tend to like to die.", KOTOHIME.HAPPY),
	txt("Some make peace. Some do not.", KOTOHIME.HAPPY),
	txt("But all of them loathe certain deaths... the deaths of their loved ones.", KOTOHIME.HAPPY),
	...
	txt("For anyone's love to be invincible... it is a wish presumptuous to the point that few would begin such ideations.", KOTOHIME.HAPPY),
	txt("Yet you live it. If you were to find love, your inheritance of the Hourai would only be celebrated.", KOTOHIME.HAPPY),
	txt("...Kotohime, you..."),
	txt("Obviously!"),
	txt("Oh, there's more where that came from.", KOTOHIME.HAPPY),
	...
	txt("If you have reason to abandon this venture after this, Kaguya, I will not stop you. Love ought to be to one's own discretion.", KOTOHIME.HAPPY),
	txt("But if it is for such feeble reasoning as \"I am unsuited\", I will not allow you to falter!", KOTOHIME.HAPPY),
	txt("The final reason you're perfect for this is...!", KOTOHIME.HAPPY),
