function txt_closing() {
	...
	txt("...You remember, don't you, Kaguya?", KOTOHIME.HAPPY, SPRITEPOS.MIDRIGHT, s_court, function() {music_set(mus.null)}),
	...
	txt("Yes, I had noticed.", KAGUYA2.HAPPY, SPRITEPOS.MIDLEFT),
	txt("She is unsuited to the modern ways of Gensokyo, and doesn't have any notable social standing.", KOTOHIME.THINKING, SPRITEPOS.MIDRIGHT, s_court),
	txt("I do not resent her for it.", KAGUYA2.HAPPY),
	txt("Elly is wise and skilled, but she's been lost ever since she lost her last stay.", KAGUYA2.HAPPY),
	txt("I imagine that as a wandering reaper, it's difficult to make connections.", KAGUYA2.HAPPY),
	txt("Of course... of course.", KOTOHIME.THINKING, SPRITEPOS.MIDRIGHT, s_court),
	txt("As a reaper...", KOTOHIME.SMUG),
	txt("!#You intend to say-", KAGUYA2.SURPRISED),
	txt("Yes!", KOTOHIME.HAPPY, SPRITEPOS.MIDRIGHT, s_court, function() {music_set(mus.gaming)}),
	...
	txt("...She is a fairly striking woman.", KAGUYA2.DISAPPOINTED),
	txt("Then I will not have the great Kaguya-hime in trepidation.", KOTOHIME.LMAO, SPRITEPOS.MIDRIGHT, s_court),
	...
	txt("I am fine not being reminded of that, thank you.", KAGUYA2.ANGRY),
	txt("...I'm sorry. I simply mean to say that, Kaguya...", KOTOHIME.DISAPPOINTED, SPRITEPOS.MIDRIGHT, s_court),
