function txt_walking() {
	...
	txt("..."),
	txt("So, Kotohime, what sort of place are we headed?", KAGUYA.NORMAL, SPRITEPOS.LEFT),
	...
	txt("It's still hard for me to imagine doing that...", KAGUYA.NORMAL),
	...
	txt("I suppose I must have missed that week's issue...", KAGUYA.NORMAL),
	...
	txt("It is true that even my failed plans from long ago moved us at Eientei forward, in regards to social status in Gensokyo.", KAGUYA.NORMAL),
	...
	txt("Not so different from my current residence, then.", KAGUYA.NORMAL),
	txt("Oh, I guess it isn't.", KOTOHIME.NORMAL),
	txt("..."),
	txt("Oh, one thing-", KOTOHIME.NORMAL, SPRITEPOS.MIDRIGHT),
	txt("...Yes?", KAGUYA.NORMAL),
	txt("Wait, were you just hovering?", KOTOHIME.NORMAL),
	txt("Ah~ Maybe...", KAGUYA.NORMAL),
	txt("But, you were walking too fast!", KAGUYA.NORMAL),
