function txt_objection() {
	...
	txt("You are very confident.", KAGUYA2.EXCITED, SPRITEPOS.MIDLEFT),
	txt("Do you truly believe this is sustainable? It is inevitable that my identity would come to light.", KAGUYA2.GRIN),
	txt("Be it by a slip of the tongue, an accidental use of my powers, or even a knowledgable passerby...", KAGUYA2.GRIN),
	txt("Can you argue that such is not inevitable?", KAGUYA2.EXCITED),
