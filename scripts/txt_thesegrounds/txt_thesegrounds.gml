function txt_thesegrounds() {
	...
	txt("Take that!"),
	txt("It's this!"),
	txt("Your perception of being a \"dangerous person to meet\"!"),
	txt("The public has a pre-conceived notion of \"Princes Kaguya\"."),
	txt("However, it would be clear to both Chiyurii and Elly that you are, in fact, very personable."),
	txt("You fool!"),
