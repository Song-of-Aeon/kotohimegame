...
function txt_gengetsu() {
	...
	txt("...I do not. Maybe it's because something-getsu here is too IMPATIENT and wouldn't let me breathe for a MOMENT without some impossible pattern!", KOTOHIME.HAPPY),
...
function txt_sariel() {
	...
	txt("I don't really know what their deal is, but they're nice.", KOTOHIME.HAPPY),
	txt("What an interesting being. Surely not human or youkai...", KAGUYA2.NORMAL),
	txt("Nor a god or of pure lands. Who knows?", KOTOHIME.HAPPY),
	txt("Our scientist there used to really have a problem with them.", KOTOHIME.HAPPY),
	txt("Kept shoving evidence that supposedly proved that \"they couldn't exist\" to their face.", KOTOHIME.HAPPY),
...
function txt_ruukoto() {
	...
	txt("She is quite fine. Ruukoto there isn't like us. She's a living metal doll.", KOTOHIME.HAPPY, SPRITEPOS.MIDLEFT),
