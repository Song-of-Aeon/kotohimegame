function txt_gmod() {
	...
	txt("The middle one. \"Garry's Mod\".", KAGUYA2.NORMAL, SPRITEPOS.CENTER, s_black),
	txt("Is that how you say it? I can't read any of this western text.", KOTOHIME.HAPPY, SPRITEPOS.MIDLEFT),
	...
	txt("..."),
	txt("Wahahahaha!", KOTOHIME.HAPPY, SPRITEPOS.LEFT),
	...
	txt("|aAh! |aDang. That can't stop me! In this world, I've got the same convenient body you do!", KOTOHIME.HAPPY, u, u, u, [se_null, se_null]),
	txt("If I pick up the crossbow here...", KOTOHIME.HAPPY),
	txt("There! Got you!", KOTOHIME.HAPPY),
	...
	txt("What do you... |a|w0020no |a|w0020way! You set the whole place to blow, even though you were inside?", KOTOHIME.HAPPY, u, u, u, [se_null, se_null]),
	...
	txt("How pragmatic.", KOTOHIME.HAPPY),
