...
function st_textcourt() {
	surface_set_target(global.surfaces.HUD);
	i = 0;
	draw_sprite_ext(bg, 0, 640, 0, ineg(talker[i].position < SPRITEPOS.CENTER), 1, 0, c_white, 1);
	draw_sprite_ext(s_desk, 0, 640, 0, ineg(talker[i].position < SPRITEPOS.CENTER), 1, 0, c_white, 1);
	draw_sprite_ext(talker[i].sprite,
	talker[i].index,
	talker[i].x,
	talker[i].y,
