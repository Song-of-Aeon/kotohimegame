function txt_chillin() {
	...
	txt("Alas, the eve has already given way to morrow.", KOTOHIME.HAPPY, SPRITEPOS.LEFT),
	...
	txt("No, I ought to not.", KOTOHIME.HAPPY),
	txt("I'm sure to have mountains of work upon my unexpected return.", KOTOHIME.HAPPY),
	txt("Peoples' campaigns, marriage proposals...", KOTOHIME.HAPPY),
	txt("Would you believe it? This era's Miare doesn't see fit to give me an entry in the Gensokyo Chronicle!", KOTOHIME.HAPPY),
	txt("I even wrote it for her! I personally deliver a copy every week, but I'm always turned away by the servants.", KOTOHIME.HAPPY),
	txt("Troublesome, surely...", KAGUYA2.NORMAL),
	txt("Besides that, marriage proposals?", KAGUYA2.NORMAL),
	txt("Yes, yes. None of them are even close to worthy.", KOTOHIME.HAPPY),
	txt("Many of them from the people that seem to give me sneers on the street, even.", KOTOHIME.HAPPY),
	txt("My landlord even frequents the list! He's old, and he always looks like he wants something from me.", KOTOHIME.HAPPY),
	...
	txt("Hmmm? Sounds wise-ish.", KOTOHIME.HAPPY),
	...
	txt("Let's get you in the game, Kaguya.", KOTOHIME.HAPPY),
	...
	txt("Is there truly no man or woman who can satisfy the isolated, cruel beauty Kaguya-hime?", KOTOHIME.HAPPY),
	txt("Oh, woe is her, only to ever have been given such meek and impure love!", KOTOHIME.HAPPY),
	...
	txt("It can be done.", KOTOHIME.HAPPY),
	txt("For your first point, that you're too well-known...", KOTOHIME.HAPPY),
	...
	txt("There are many walks of life, dear princess. They only all converge on their origin and termination.", KOTOHIME.HAPPY),
	txt("...Barring yourself.", KOTOHIME.HAPPY),
	txt("But, in Gensokyo?", KAGUYA2.NORMAL),
	txt("In Gensokyo.", KOTOHIME.HAPPY),
