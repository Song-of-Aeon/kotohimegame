function txt_freedom() {
	...
	txt("Hehe, that was fun.", KAGUYA2.EXCITED, SPRITEPOS.LEFT, u, function() {music_set(mus.mokou)}),
	txt("We're just getting started! Although, we should leave posthaste. Reisen won't be long.", KOTOHIME.HAPPY),
	txt("Let us be off, then.", KAGUYA2.HAPPY),
	...
	txt("...Are you incapable of it?", KAGUYA2.SURPRISED),
	txt("I had simply not expected it.", KOTOHIME.THINKING),
	txt("How does one...", KAGUYA2.CONFUSED),
	...
	txt("Will you not fly until every human takes the time to learn?", KAGUYA2.SURPRISED),
	...
	txt("I don't mind walking, then. We are less likely to be seen, as well.", KAGUYA2.HAPPY),
