nu pattern_ext(function() {
	if nam(++count, 4) c_shootcircle(x+seed.next(100)-50, y+seed.next(100)-50, 4, seed.next(360), 36, choose(bul.smolerboolit, bul.smolerboolit, bul.bigerboolit), c_blue);
	...
	if ncm(4) { //every four frames
		c_shootcircle( //shoot a circle of bullets,
			...
			choose(bul.smolerboolit, bul.smolerboolit, bul.bigerboolit), //of one of these bullet types,
			c_blue //that is blue.
		);
	}
}, 600, 70, "mokou", SPELL.CARD, DIFFICULTY.HARD, "Midnight Alarm");
