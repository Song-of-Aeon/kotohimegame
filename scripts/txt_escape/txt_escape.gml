function txt_escape() {
	...
	txt("No, it isn't, but I had supposed that a modium of discretion would be helpful.", KAGUYA2.HAPPY, SPRITEPOS.MIDRIGHT),
	txt("Eirin is fond of your help... but she is suspicious of you in many ways, and would not see me off under your supervision.", KAGUYA2.DISAPPOINTED),
	...
	txt("Were we not planning for that already?", KAGUYA2.CONFUSED),
	...
	txt("I see. It endangers your own position here, you know.", KAGUYA2.HAPPY),
