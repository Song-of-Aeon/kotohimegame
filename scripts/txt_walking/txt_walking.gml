function txt_walking() {
	...
	txt("It will come to you, surely.", KOTOHIME.HAPPY),
	...
	txt("Most of us, that is. I was quite successful in my legendary battle against her. I'm sure you've heard the stories.", KOTOHIME.HAPPY),
	txt("I suppose I must have missed that week's issue...", KAGUYA2.NORMAL),
	txt("Anyway, I hear it used to hurt a lot more to lose to her.", KOTOHIME.HAPPY),
	txt("Before the spellcard rules, she din't think twice even about exterminating youkai for good.", KOTOHIME.HAPPY),
	txt("Plus, you didn't get the sort of fame for starting an incident that you do now.", KOTOHIME.HAPPY),
	txt("If you lost, nothing good came of it.", KOTOHIME.HAPPY),
	...
	txt("Less fortune was spared for those in the back.", KOTOHIME.HAPPY),
	txt("Almost everybody seems to be over it, but we still meet at the bar.", KOTOHIME.HAPPY),
	txt("The Twilight Bar is an incredible and secluded place, that can block out even fantasy.", KOTOHIME.HAPPY),
	...
	txt("Wait, were you just hovering?", KOTOHIME.HAPPY),
