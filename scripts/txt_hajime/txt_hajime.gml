...
function txt_hajime() {
	...
	txt("What? Oh, you. It's nothing. You're welcome.", KOTOHIME.HAPPY, SPRITEPOS.LEFT),
	...
	txt("I'm sure you understand, then. The weight of this mission...", KOTOHIME.HAPPY),
	txt("Anyway, let's go! Take me to Kaguya!", KOTOHIME.HAPPY),
