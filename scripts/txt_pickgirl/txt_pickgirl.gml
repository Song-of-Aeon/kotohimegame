function txt_kana() {
	...
	txt("|c102137255Could that be...?", KAGUYA.NORMAL, SPRITEPOS.MIDRIGHT),
	txt("|c102137255It's subtle, but that person isn't fully tainted by the Earth.", KAGUYA.NORMAL),
...
function txt_gengetsu() {
	...
	txt("Kotohime, that girl seems interesting.", KAGUYA.NORMAL, SPRITEPOS.MIDRIGHT),
...
function txt_sariel() {
	...
	txt("Those two don't seem very well-matched.", KAGUYA.NORMAL, SPRITEPOS.MIDRIGHT),
