function txt_deception() {
	...
	txt("...", u, u, u, function() {music_set(mus.null)}),
	txt("That was heavy. I don't think I've ever seen the princess get so mad...", REISEN.HAPPY, SPRITEPOS.LEFT, s_bamboo, function() {music_set(mus.chillin)}),
	txt("What did you do?", REISEN.SURPRISED),
	...
	txt("How did you...", REISEN.SURPRISED),
	txt("Wait, you showed it to Eirin and I before you met the princess.", REISEN.DAMN),
	txt("That was, uh, the last one. I still had it with me.", KOTOHIME.NERVOUS),
	txt("And you were together for so long. How did she just notice now?", REISEN.DAMN),
	...
	txt("You know what, whatever. I can't even have any sympathy for you.", REISEN.GODDAMN),
	txt("I've got some work to do. I'll see you around, maybe.", REISEN.SHITSTUFF),
	...
	txt("...Gah. What are you going to do?", REISEN.GODDAMN),
	txt("It's simple! Help me look for that thing!", KOTOHIME.HAPPY, SPRITEPOS.RIGHT),
	txt("I don't think I can help with that. It's incredibly tiny.", REISEN.DAMN),
	txt("If you haven't made a habit of burning bridges all around Gensokyo, maybe you could get someone skilled at finding lost things?", REISEN.DAMN),
	...
	txt("Fine, fine.", REISEN.SHITSTUFF),
