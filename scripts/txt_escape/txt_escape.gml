function txt_escape() {
	...
	txt("Really? I thought we were on the same page. My heart aches at this...", KOTOHIME.HAPPY),
	txt("That settles it. If it's come down to this, we'll need to...", KOTOHIME.HAPPY),
	txt("Escape!", KOTOHIME.HAPPY),
	txt("Were we not planning for that already?", KAGUYA2.NORMAL),
	txt("And I've got the perfect idea...", KOTOHIME.HAPPY),
	txt("...", KAGUYA2.NORMAL),
	...
	txt("Simply, uh...", KOTOHIME.HAPPY),
	txt("Well. The future is boundless, right?", KOTOHIME.HAPPY),
	...
	txt("!!", REISEN.HAPPY),
	txt("Aaaah!", KOTOHIME.HAPPY, SPRITEPOS.CENTER),
	txt("Hey, it was just a small mistake~", KOTOHIME.HAPPY),
	txt("I DO NOT CARE! LYING TO ME IS A SIN IN AND OF ITSELF!!", KAGUYA2.NORMAL),
	txt("Ow, ow, okay, okay! I'll leave.", KOTOHIME.HAPPY),
